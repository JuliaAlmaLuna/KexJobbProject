...
visual_score_adam_tanh = np.load('adam_tanh/visual_score.npy', allow_pickle=True)
...
visual_score_adam_relu = np.load('adam_relu/visual_score.npy', allow_pickle=True)
...
pearson_sgd_relu = np.load('sgd_relu/pearson.npy', allow_pickle=True)
r2_sgd_relu = np.load('sgd_relu/r2.npy', allow_pickle=True)
mse_sgd_relu = np.load('sgd_relu/mse.npy', allow_pickle=True)
visual_score_sgd_relu = np.load('sgd_relu/visual_score.npy', allow_pickle=True)
visual_score_sgd_relu = [int(i) for i in visual_score_sgd_relu]
...
plt.plot(x, pearson_sgd_relu, label='sgd relu')
plt.ylabel("PCC")
...
plt.plot(x, visual_score_sgd_relu)
plt.ylabel("Visual score (0-10)")
plt.xlabel("Test number")

plt.figlegend()
plt.suptitle("Test of performance: Dataset 1B")
plt.show()
...
print("SGD relu")
print("Pearson: " + str(np.average(pearson_sgd_relu)) + " R2: " + str(np.average(r2_sgd_relu)) + " MSE: " +
      str(np.average(mse_sgd_relu)) + " Visual score: " + str(np.average(visual_score_sgd_relu)))
